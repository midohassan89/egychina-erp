...
export default function OpeningBalancePage() {
  ...
  async function save() {
    ...
    try {
      ...
      const body = (await res.json()) as { id?: number; error?: string; wooError?: string | null };
      if (!res.ok) {
      ...
      setSuccessNote(
        body.wooError
          ? `Opening balance #${body.id} saved. WooCommerce sync failed: ${body.wooError}`
          : `Opening balance #${body.id} saved. Stock and piece cost are updated.`,
      );
    } catch {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-900">Opening Balance</h1>
